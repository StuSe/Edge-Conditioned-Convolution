...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 11:27:10 2019
...
def main():
    ...
    # Dataset 
    parser.add_argument('--dataset', default='modelnet10', help='Dataset name: sydney|modelnet10|modelnet40')    
    ...
    # Decide on the dataset (Sydney is not relevant for this work)
    ...
    def eval(epoch):
        ...
        return acc_meter.value()[0], f1, cacc, cm_meter, test
    ...
    for epoch in range(args.start_epoch, args.epochs):        
        ...
        if (epoch+1) % args.test_nth_epoch == 0 or epoch+1==args.epochs:
            acc_test, f1_test, cacc_test, cm_meter, test = eval(epoch)  
